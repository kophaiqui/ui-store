      ...
      {selected?.values && (() => {
        ...
        return (
          <div className="overflow-hidden rounded-xl border border-border bg-background">
            ...
            <div className={propTab === "preview" ? "relative overflow-hidden bg-card px-8 py-8" : "hidden"}>
              <div className="pointer-events-none absolute inset-0" style={GRID_BG} />
              <div className="pointer-events-none absolute inset-0" style={{ background: "radial-gradient(ellipse 75% 75% at 50% 50%, transparent 30%, var(--preview-vignette) 100%)" }} />
