...
- [ ] style audit: default + glass done (both clean), 6 of 8 columns left in docs/audits/STYLE_AUDIT.md. reusable helper: scripts/audit-style-screenshots.mjs <style> <outDir> (dev server must be running)
