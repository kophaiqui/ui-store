...
export const glassStyle: AlertStyleConfig = {
  ...
  variants: {
    info: {
      ...
      descColor:     "text-sky-600 dark:text-sky-300/60",
    ...
    success: {
      ...
      descColor:     "text-emerald-600 dark:text-emerald-300/60",
    ...
    warning: {
      ...
      descColor:     "text-amber-600 dark:text-amber-300/60",
    ...
    error: {
      ...
      descColor:     "text-red-600 dark:text-red-300/60",
