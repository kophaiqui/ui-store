...
export const auroraStyle: DrawerStyleConfig = {
  backdrop:
  ...
  popup:
    "fixed bg-[#0b1022]/95 backdrop-blur-xl border-indigo-400/20 shadow-[0_0_50px_rgba(99,102,241,0.15)] focus:outline-none overflow-y-auto flex flex-col",
  positions: {
