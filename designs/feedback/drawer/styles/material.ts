...
export const materialStyle: DrawerStyleConfig = {
  backdrop:
  ...
  popup:
    "fixed bg-white border-violet-200/40 dark:bg-[#1d1b20] dark:border-violet-800/30 focus:outline-none overflow-y-auto flex flex-col",
  positions: {
