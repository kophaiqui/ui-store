...
export const neobrutalismStyle: ToastStyleConfig = {
  ...
  variants: {
    default: { border: "border-zinc-950",  progressColor: "bg-zinc-950",    titleColor: "text-zinc-900",   descColor: "text-zinc-600"  },
    success: { border: "border-zinc-950",  progressColor: "bg-yellow-400",  titleColor: "text-zinc-900",   descColor: "text-zinc-600"  },
    error:   { border: "border-zinc-950",  progressColor: "bg-red-500",     titleColor: "text-zinc-900",   descColor: "text-zinc-600"  },
    warning: { border: "border-zinc-950",  progressColor: "bg-orange-500",  titleColor: "text-zinc-900",   descColor: "text-zinc-600"  },
  },
};
