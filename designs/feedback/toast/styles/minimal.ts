...
export const minimalStyle: ToastStyleConfig = {
  ...
  variants: {
    default: { border: "border-foreground",    progressColor: "bg-foreground"  },
    success: { border: "border-emerald-500",   progressColor: "bg-emerald-500" },
    error:   { border: "border-red-500",       progressColor: "bg-red-500"     },
    warning: { border: "border-amber-500",     progressColor: "bg-amber-500"   },
  },
};
