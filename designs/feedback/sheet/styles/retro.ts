...
export const retroStyle: SheetStyleConfig = {
  ...
  popup: "fixed z-[60] bg-[#fdf6e3] border-[#3d2410] focus:outline-none overflow-y-auto flex flex-col dark:bg-[#161324] dark:border-[#A78BFA]",
  sides: {
    right:  "inset-y-0 right-0 border-l-2 shadow-[-6px_0_0_0_#3d2410] data-[starting-style]:translate-x-full data-[ending-style]:translate-x-full transition-transform duration-300 dark:shadow-[-6px_0_0_0_#A78BFA]",
    left:   "inset-y-0 left-0 border-r-2 shadow-[6px_0_0_0_#3d2410] data-[starting-style]:-translate-x-full data-[ending-style]:-translate-x-full transition-transform duration-300 dark:shadow-[6px_0_0_0_#A78BFA]",
    top:    "inset-x-0 top-0 border-b-2 shadow-[0_6px_0_0_#3d2410] data-[starting-style]:-translate-y-full data-[ending-style]:-translate-y-full transition-transform duration-300 dark:shadow-[0_6px_0_0_#A78BFA]",
    bottom: "inset-x-0 bottom-0 border-t-2 shadow-[0_-6px_0_0_#3d2410] data-[starting-style]:translate-y-full data-[ending-style]:translate-y-full transition-transform duration-300 dark:shadow-[0_-6px_0_0_#A78BFA]",
  },
