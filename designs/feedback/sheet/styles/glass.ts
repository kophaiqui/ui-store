...
export const glassStyle: SheetStyleConfig = {
  ...
  popup: "fixed z-[60] bg-black/40 backdrop-blur-2xl border-white/10 focus:outline-none overflow-y-auto flex flex-col shadow-[0_0_64px_rgba(0,0,0,0.6),inset_0_1px_0_rgba(255,255,255,0.06)]",
  sides: {
  ...
  header: "flex items-start justify-between gap-4 border-b border-white/10 p-5",
  title: "text-base font-semibold text-foreground",
  description: "mt-0.5 text-sm text-foreground/60",
  close: "flex size-7 shrink-0 items-center justify-center rounded-lg text-foreground/50 transition-colors hover:text-foreground hover:bg-white/10 focus-visible:outline-none",
