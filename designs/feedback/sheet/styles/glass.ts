...
export const glassStyle: SheetStyleConfig = {
  ...
  popup: "fixed z-[60] bg-white/80 backdrop-blur-2xl border-black/10 dark:bg-black/40 dark:border-white/10 focus:outline-none overflow-y-auto flex flex-col shadow-[0_0_64px_rgba(0,0,0,0.08),inset_0_1px_0_rgba(255,255,255,0.8)] dark:shadow-[0_0_64px_rgba(0,0,0,0.6),inset_0_1px_0_rgba(255,255,255,0.06)]",
  sides: {
