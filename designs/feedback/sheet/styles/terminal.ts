...
export const terminalStyle: SheetStyleConfig = {
  ...
  popup: "fixed z-[60] bg-white border-[#16A34A] dark:bg-[#0A0A0A] dark:border-[#22C55E] focus:outline-none overflow-y-auto flex flex-col",
  sides: {
