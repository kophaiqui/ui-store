...
export const glassStyle: PaginationStyleConfig = {
  ...
  item: "",
  btn: "flex items-center justify-center rounded-lg border border-white/10 bg-white/8 backdrop-blur-sm font-medium text-foreground/80 shadow-[inset_0_1px_0_rgba(255,255,255,0.07)] transition-all duration-100 hover:bg-white/12 hover:text-foreground active:scale-[0.95] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-sky-400/40 disabled:cursor-not-allowed disabled:opacity-40",
  sizes: {
