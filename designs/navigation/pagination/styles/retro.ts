...
export const retroStyle: PaginationStyleConfig = {
  ...
  active: "bg-[#e8743b] border-[#3d2410] text-[#2c1a0e] shadow-[3px_3px_0px_0px_#3d2410] hover:bg-[#d4612a] hover:translate-x-0 hover:translate-y-0 hover:shadow-[3px_3px_0px_0px_#3d2410]",
  disabled: "opacity-40 cursor-not-allowed pointer-events-none",
  ellipsis: "flex items-end justify-center pb-0.5 text-[#7a5230] font-black select-none",
  prevNext: "",
  firstLast: "",
};
