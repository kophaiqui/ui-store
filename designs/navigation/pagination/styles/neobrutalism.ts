...
export const neobrutalismStyle: PaginationStyleConfig = {
  ...
  item: "",
  btn: "flex items-center justify-center rounded-none border-2 border-zinc-950 bg-white font-bold text-zinc-950 transition-all duration-100 hover:translate-x-[1px] hover:translate-y-[1px] hover:shadow-none shadow-[2px_2px_0px_0px_#09090b] focus-visible:outline-none disabled:cursor-not-allowed disabled:opacity-40",
  sizes: {
  ...
  ellipsis: "flex items-end justify-center pb-0.5 text-zinc-700 font-bold select-none",
  prevNext: "",
  firstLast: "",
};
