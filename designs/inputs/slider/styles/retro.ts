...
export const retroStyle: SliderStyleConfig = {
  track: "relative h-2 w-full rounded-none bg-amber-100 border-2 border-[#3d2410] shadow-[2px_2px_0px_0px_#3d2410] data-[disabled]:opacity-50",
  indicator: "absolute h-full rounded-none bg-[#e8743b] data-[disabled]:bg-[#7a5230]",
