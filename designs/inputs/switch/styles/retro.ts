...
export const retroStyle: SwitchStyleConfig = {
  track: "group relative inline-flex shrink-0 items-center rounded-sm border-2 border-[#3d2410] bg-amber-100 transition-colors duration-200 data-[checked]:bg-[#e8743b] data-[checked]:border-[#3d2410] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#e8743b]/50 focus-visible:ring-offset-1 disabled:pointer-events-none disabled:opacity-50 shadow-[2px_2px_0px_0px_#3d2410]",
  thumb: "pointer-events-none block rounded-[2px] bg-[#fdf6e3] border border-[#3d2410] shadow-[1px_1px_0px_0px_#3d2410] translate-x-0 transition-transform duration-200 ease-out",
  sizes: {
