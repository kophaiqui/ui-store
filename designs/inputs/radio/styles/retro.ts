...
export const retroStyle: RadioStyleConfig = {
  root: "relative flex shrink-0 items-center justify-center rounded-full border-2 border-[#3d2410] bg-[#fdf6e3] transition-all duration-100 hover:bg-amber-100 data-[checked]:border-[#e8743b] data-[checked]:bg-amber-50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#e8743b]/50 focus-visible:ring-offset-1 disabled:pointer-events-none disabled:opacity-50 shadow-[2px_2px_0px_0px_#3d2410] dark:border-[#A78BFA] dark:bg-[#161324] dark:hover:bg-[#A78BFA]/20 dark:data-[checked]:border-[#A78BFA] dark:data-[checked]:bg-[#A78BFA]/15 dark:focus-visible:ring-[#A78BFA]/50 dark:shadow-[2px_2px_0px_0px_#A78BFA]",
  sizes: {
    sm: "size-[14px]",
    md: "size-[18px]",
    lg: "size-[22px]",
  },
  dot: "rounded-full bg-[#e8743b] transition-transform duration-100 scale-0 data-[checked]:scale-100 dark:bg-[#A78BFA]",
  dotSizes: {
    sm: "size-[6px]",
    md: "size-[8px]",
    lg: "size-[10px]",
