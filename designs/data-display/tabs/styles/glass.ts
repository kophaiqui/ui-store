...
export const glassStyle: TabsStyleConfig = {
  list: "relative flex gap-0 border-b border-black/10 dark:border-white/10",
  indicator: "absolute bottom-0 left-0 h-px bg-sky-500 dark:bg-sky-400 transition-all duration-200 ease-out",
