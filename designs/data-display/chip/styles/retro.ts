...
export const retroStyle: ChipStyleConfig = {
  ...
  selected:   "bg-[#e8743b] border-[#3d2410] text-[#2c1a0e] shadow-[2px_2px_0px_0px_#3d2410]",
  unselected: "bg-[#fdf6e3] border-[#3d2410] text-[#7a5230] hover:bg-amber-100 hover:text-[#2c1a0e] shadow-[1px_1px_0px_0px_#3d2410]",
  sizes: {
